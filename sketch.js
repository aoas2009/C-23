...
function setup() {
  ...
  plate1 = Bodies.rectangle(100,300,100,20,plate_options);
  World.add(world,plate1);

  plate2 = Bodies.rectangle(300,300,100,20,plate_options);
  World.add(world,plate2);

  rot1 = Bodies.rectangle(200,100,150,10,rotator_options);
  World.add(world,rot1);

  rot2 = Bodies.rectangle(200,100,150,10,rotator_options);
  World.add(world,rot2);

  rot3 = Bodies.rectangle(200,100,150,10,rotator_options);
